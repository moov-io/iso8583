...
func TestEBCDICVarPrefixer_LHelpers(t *testing.T) {
	tests := []struct {
		...
		{EBCDIC.L, 5, 3, []byte{0xf3}},
		{EBCDIC.LL, 20, 2, []byte{0xf0, 0xf2}},
		{EBCDIC.LL, 20, 12, []byte{0xf1, 0xf2}},
		{EBCDIC.LLL, 340, 2, []byte{0xf0, 0xf0, 0xf2}},
		{EBCDIC.LLL, 340, 200, []byte{0xf2, 0xf0, 0xf0}},
		{EBCDIC.LLLL, 9999, 1234, []byte{0xf1, 0xf2, 0xf3, 0xf4}},
	}
