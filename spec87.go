...
var Spec87 *MessageSpec = &MessageSpec{
	Fields: map[int]field.Field{
		...
		11: field.NewString(&field.Spec{
			Length:      6,
			Identifier:  "Systems Trace Audit Number",
		...
		23: field.NewString(&field.Spec{
			Length:      3,
			Identifier:  "Card Sequence Number",
		...
		43: field.NewString(&field.Spec{
			Length:      40,
			Identifier:  "Card Acceptor Name Location",
		...
		46: field.NewString(&field.Spec{
			Length:      999,
			Identifier:  "Additional data ISO",
		...
		48: field.NewString(&field.Spec{
			Length:      999,
			Identifier:  "Additional data Private",
		...
		55: field.NewString(&field.Spec{
			Length:      999,
			Identifier:  "ICC Data EMV Having Multiple Tags",
		...
		57: field.NewString(&field.Spec{
			Length:      999,
			Identifier:  "Reserved National 57",
		...
		58: field.NewString(&field.Spec{
			Length:      999,
			Identifier:  "Reserved National 58",
			Description: "Reserved (National)",
			Enc:         encoding.ASCII,
			Pref:        prefix.ASCII.LLL,
		}),
		59: field.NewString(&field.Spec{
			Length:      999,
			Identifier:  "Reserved National 59",
			Description: "Reserved (National)",
			Enc:         encoding.ASCII,
			Pref:        prefix.ASCII.LLL,
		}),
		60: field.NewString(&field.Spec{
			Length:      999,
			Identifier:  "Reserved National 60",
			Description: "Reserved (National)",
			Enc:         encoding.ASCII,
			Pref:        prefix.ASCII.LLL,
		}),
		61: field.NewString(&field.Spec{
			Length:      999,
			Identifier:  "Reserved Private 61",
		...
		62: field.NewString(&field.Spec{
			Length:      999,
			Identifier:  "Reserved Private 62",
			Description: "Reserved (Private)",
			Enc:         encoding.ASCII,
			Pref:        prefix.ASCII.LLL,
		}),
		63: field.NewString(&field.Spec{
			Length:      999,
			Identifier:  "Reserved Private 63",
			Description: "Reserved (Private)",
			Enc:         encoding.ASCII,
			Pref:        prefix.ASCII.LLL,
		}),
		64: field.NewString(&field.Spec{
			Length:      8,
			Identifier:  "Message Authentication Code",
